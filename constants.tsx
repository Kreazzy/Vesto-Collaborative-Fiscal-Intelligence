...
export const ALL_CURRENCIES: { code: string; name: string; symbol: string }[] = [
...
export const CURRENCY_SYMBOLS: Record<string, string> = ALL_CURRENCIES.reduce((acc, curr) => {
